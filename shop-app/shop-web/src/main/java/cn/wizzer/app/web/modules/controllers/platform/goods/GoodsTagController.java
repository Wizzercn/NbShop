...
public class GoodsTagController {
    ...
    @At("")
    @Ok("beetl:/platform/goods/tag/index.html")
    ...
    @At
    @Ok("beetl:/platform/goods/tag/add.html")
    @RequiresAuthentication
    ...
    public Object addDo(@Param("..") Goods_tag shopGoodsTag, HttpServletRequest req) {
        try {
    ...
    @At("/edit/?")
    @Ok("beetl:/platform/goods/tag/edit.html")
    @RequiresAuthentication
    ...
    @AdaptBy(type = WhaleAdaptor.class)
    //uploadifive上传文件后contentTypy改变,需要用WhaleAdaptor接收参数
    public Object editDo(@Param("..") Goods_tag shopGoodsTag, HttpServletRequest req) {
        try {
