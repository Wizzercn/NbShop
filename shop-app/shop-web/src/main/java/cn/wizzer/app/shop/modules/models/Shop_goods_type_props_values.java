...
public class Shop_goods_type_props_values extends BaseModel implements Serializable {
    ...
    @One(target = Shop_goods_type_props.class, field = "propsId")
    private Shop_goods_type_props typeProps;
    ...
    public Shop_goods_type_props getTypeProps() {
        return typeProps;
    }

    public void setTypeProps(Shop_goods_type_props typeProps) {
